...
.PHONY: all test clean deploy deployChallenge fund help install snapshot format anvil
...
deployChallenge:
	@forge script script/DeployChallenge.s.sol:DeployChallenge $(NETWORK_ARGS)
